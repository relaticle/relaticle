...
return [
    ...
    // Claves propias de Relaticle (lang/en/validation.php).
    'custom_field' => [
        'unknown_option' => ':field: la opción ":value" no es ninguna de estas: :labels.',
        'ambiguous_option' => ':field: la opción ":value" es ambigua; indica el ID de la opción.',
        'single_option' => ':field: indica una sola etiqueta o ID de opción.',
        'option_list' => ':field: indica una lista de etiquetas o ID de opciones.',
        'foreign_records' => ':field: los registros :ids no pertenecen a este espacio de trabajo.',
        'unsupported_lookup' => ':field: el tipo de búsqueda ":type" no se puede escribir desde la API, el MCP ni el chat.',
        'record_ids' => ':field: indica una lista de ID de registros.',
    ],
    'indisposable' => 'No se permiten direcciones de correo desechables.',
];
