...
return [
    ...
    'paused' => [
        ...
        'review' => [
            ...
            'rate_yearly' => '$19 / month',
            'rate_monthly' => '$24 / month',
            'included' => 'What’s included',
            'summary' => 'Payment summary',
            'per_year' => 'Per year',
            'per_month' => 'Per month',
            'line_item' => 'Cloud Pro for :workspace',
            'credits' => ':credits AI credits / month',
            'credits_included' => 'Included',
            'amount_yearly' => '$228.00',
            'amount_monthly' => '$24.00',
            'subtotal' => 'Subtotal',
            'tax' => 'Tax',
            'tax_at_checkout' => 'Calculated at checkout',
            'total_yearly' => 'Total per year',
            'total_monthly' => 'Total per month',
            'proceed' => 'Proceed to payment',
            'secure' => 'Secure checkout by Stripe. Cancel anytime.',
        ],
    ],
    'pro_plan' => [
