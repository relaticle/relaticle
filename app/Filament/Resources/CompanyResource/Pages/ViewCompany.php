        ...
        return $schema
            ->schema([
                ...
                Section::make('Communication Intelligence')
                    ...
                    ->schema([
                        TextEntry::make('last_interaction_at')
                            ->label(__('filament/resources/company.communication_intelligence.fields.last_interaction_at.label'))
                            ->dateTime()
                            ->placeholder(__('filament/resources/company.communication_intelligence.fields.last_interaction_at.placeholder')),

                        TextEntry::make('last_email_at')
                            ->label(__('filament/resources/company.communication_intelligence.fields.last_email_at.label'))
                            ->dateTime()
                            ->placeholder(__('filament/resources/company.communication_intelligence.fields.last_email_at.placeholder')),

                        TextEntry::make('days_since_last_email')
                            ->label(__('filament/resources/company.communication_intelligence.fields.days_since_last_email.label'))
                            ->getStateUsing(fn (Company $record): string => $record->last_email_at
                                ? __('filament/resources/company.communication_intelligence.fields.days_since_last_email.days_ago', ['count' => (int) now()->diffInDays($record->last_email_at)])
                                : __('filament/resources/company.communication_intelligence.fields.days_since_last_email.no_emails_yet')
                            ),

                        TextEntry::make('email_count')
                            ->label(__('filament/resources/company.communication_intelligence.fields.email_count.label'))
                            ->default(0),

                        TextEntry::make('inbound_email_count')
                            ->label(__('filament/resources/company.communication_intelligence.fields.inbound_email_count.label')),

                        TextEntry::make('outbound_email_count')
                            ->label(__('filament/resources/company.communication_intelligence.fields.outbound_email_count.label')),
                    ])
                    ->columns(3)
                    ->columnSpanFull()
                    ->collapsible()
                ...
                Section::make('Activity log')
                    ...
                    ->description(__('filament/resources/company.activity_log.description'))
                    ->schema([
