...
final readonly class NotePolicy
{
    ...
    {
        return $user->hasWorkspaceCapability($note->workspace_id, WorkspaceCapability::RecordsView);
    }
    ...
    {
        return $user->hasWorkspaceCapability($note->workspace_id, WorkspaceCapability::RecordsUpdate);
    }

    public function delete(User $user, Note $note): bool
    {
        return $user->hasWorkspaceCapability($note->workspace_id, WorkspaceCapability::RecordsDelete);
    }
    ...
    {
        return $user->hasWorkspaceCapability($note->workspace_id, WorkspaceCapability::RecordsForceDelete);
    }
