...
final readonly class TaskPolicy
{
    ...
    {
        return $user->hasWorkspaceCapability($task->workspace_id, WorkspaceCapability::RecordsView);
    }
    ...
    {
        return $user->hasWorkspaceCapability($task->workspace_id, WorkspaceCapability::RecordsUpdate);
    }

    public function delete(User $user, Task $task): bool
    {
        return $user->hasWorkspaceCapability($task->workspace_id, WorkspaceCapability::RecordsDelete);
    }
    ...
    {
        return $user->hasWorkspaceCapability($task->workspace_id, WorkspaceCapability::RecordsForceDelete);
    }
