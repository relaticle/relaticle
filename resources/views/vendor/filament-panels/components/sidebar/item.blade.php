{{--
    Filament's `filament::components.sidebar.item`, with a leave transition on
    the label and badge. The vendor view fades them in on expand but drops them
    on frame one of a collapse, which emptied the sidebar before it narrowed.
--}}
@props([
    'active' => false,
