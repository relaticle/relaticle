{{--
    Filament's `filament::components.sidebar.group`, with a leave transition on
    the group heading only. The items block below shares those classes for the
    group's own collapse, which is a different interaction and keeps the vendor
    behaviour.
--}}
@props([
    'active' => false,
