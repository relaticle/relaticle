...
2. Cardinality: all four options, enforced on every driver inside the writer transaction (a
...
before Plan 3.1 opens, since 3.1 Task 9 rewrites the filter this bug lives in.
