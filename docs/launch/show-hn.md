...
**Title:** Show HN: Relaticle -- Open-source CRM with 32 MCP tools for AI agents

**Body:**

Relaticle is an open-source CRM (AGPL-3.0) with a production MCP server that lets AI agents manage customer data. Self-hosted, built with Laravel 13 and PHP 8.5.
...
**What's in the box:**
- MCP server with 32 tools (CRUD for companies, people, opportunities, tasks, notes + schema discovery)
...
- Built on Laravel 13, Filament 5, PostgreSQL 17, PHP 8.5
