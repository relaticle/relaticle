 ...
 * related model (filamentphp/filament#2079). Jetstream's workspace_user pivot has an
 ...
 * manager then hydrates with key 1, so record links point at /workspaces/1 and 404.
