...
| `RELATICLE_FEATURE_MARKETING` | `true` | Serve the marketing site (`/`, `/pricing`, `/contact`, `/terms-of-service`, `/privacy-policy`). Set to `false` on self-hosted installs. |

### Disable the marketing site

The homepage, pricing, contact, and legal pages are relaticle.com's marketing
content. If you're self-hosting, you almost certainly don't want your instance
serving that content verbatim — search engines end up indexing duplicate copies
of relaticle.com's pages under your domain.
