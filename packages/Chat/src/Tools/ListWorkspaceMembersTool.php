...
final class ListWorkspaceMembersTool implements Tool
{
    public function description(): string
    {
        return 'List workspace members (users). Workspace members are the ONLY valid values'
            .' for workspace-member fields: a company\'s account_owner_id and a task\'s assignee_ids.'
    ...
    public function handle(Request $request): string
    {
        ...
        $members = WorkspaceMembersContext::for($user, is_string($search) && $search !== '' ? $search : null);
