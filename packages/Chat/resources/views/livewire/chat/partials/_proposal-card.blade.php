{{-- Resolved-state audit card. The live pending proposal is hosted by the
     Livewire dock (<livewire:chat.proposal-card>); this partial only renders the
     read-only audit trail for already-resolved actions (status !== 'pending'),
     gated by the transcript x-for in chat-interface.blade.php. --}}
