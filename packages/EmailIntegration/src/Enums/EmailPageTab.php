...
/**
 * Top-level tabs on the email page. Every tab except {@see self::EMAILS} renders
 * a nested Livewire component that is also hosted by a standalone page.
 */
enum EmailPageTab: string implements HasIcon, HasLabel
{
    ...
    /**
     * The registered Livewire component rendering this tab's body, or null for
     * the mail reader, which is the page's own markup.
     */
