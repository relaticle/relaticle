...
$toolContracts = [
    ...
    CreateUploadUrlTool::class => ['title' => 'Create Upload URL', 'name' => 'create-upload-url-tool', 'annotations' => $createAnnotations],
    UploadFileTool::class => ['title' => 'Upload File', 'name' => 'upload-file-tool', 'annotations' => $createAnnotations],
